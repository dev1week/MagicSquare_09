...
| [12-refactoring-plan.md](./12-refactoring-plan.md) | Refactor 계획서 — Phase 0~4 완료, Phase 5 대기 (`209 passed`) |
...
- Refactor: [12-refactoring-plan.md](./12-refactoring-plan.md) — **Phase 0~4 완료**, Phase 5 대기 (`209 passed`)
