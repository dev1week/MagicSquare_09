...
| [12-refactoring-plan.md](./12-refactoring-plan.md) | Refactor 계획서 — Phase 0~3 완료, Phase 4~5 대기 (`201 passed`) |
...
- Refactor: [12-refactoring-plan.md](./12-refactoring-plan.md) — **Phase 0~3 완료**, Phase 4 대기 (`201 passed`)
